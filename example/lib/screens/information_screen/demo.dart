...
import 'main.dart';
import 'ticket.dart';
import '../../shared/widgets/custom_navigation_button_bar.dart'; // Make sure the path is correct
...
class _TicketFoldDemoState extends State<TicketFoldDemo> {
  ...
  final Color _backgroundColor = Colors.black; // Changed to black
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: _backgroundColor, // This applies the black background
      body: Column(
        children: [
          Padding(
            padding: const EdgeInsets.only(
                top: 40.0, bottom: 10.0), // Added bottom padding for the image
            child: Image.network(
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemCount: 2, // Limits the number of tickets shown to 2
          ...
          Padding(
            padding: const EdgeInsets.only(
                bottom: 20.0,
                top: 15.0), // Adjusted padding around the navigation bar
            child: CustomNavigationButtonBar(
              onHomePressed: () =>
                  Navigator.of(context).pushNamed('/landing_screen'),
              onCameraPressed: () =>
                  Navigator.of(context).pushNamed('/matching_screen'),
              onCollectionPressed: () =>
                  Navigator.of(context).pushNamed('/collection_screen'),
