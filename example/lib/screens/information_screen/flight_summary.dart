...
class FlightSummary extends StatelessWidget {
    ...
    return isLight
        ...
        : BoxDecoration(
            ...
            image: DecorationImage(
                image: AssetImage('assets/images_nav/bg_blue.png',
                    package: App.pkg),
                fit: BoxFit.cover),
          );
  }
  ...
  _buildLogoHeader() {
    if (isLight) {
      return Row(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Image.asset('assets/images_nav/flutter-logo.png',
      ...
      return Padding(
        ...
        child: Image.asset('assets/images_nav/logo_white.png',
  ...
  Widget _buildTicketDuration() {
    ...
    final planeImage = Image.asset('assets/images_nav/airplane_$routeType.png',
        ...
        children: <Widget>[
          Container(
            ...
            child: Stack(
              alignment: Alignment.center,
              children: <Widget>[
                Image.asset('assets/images_nav/planeroute_$routeType.png',
